...
<body>
  ...
  <div class="contact-container">
    ...
    <div class="right-col">
        <h1>Contacto</h1>
        <p>Escuchamos todas las opiniones que sean constructivas.</p>

        <form id="contact-form" method="POST" action="Enviar_mail.php">
            ...
            <button type="submit" id="submit" name="submit">Enviar</button><!--</a>-->
        </form>
        <div id="error"></div>
